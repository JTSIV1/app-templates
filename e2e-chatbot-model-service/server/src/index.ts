  ...
  if (process.env.PLAYWRIGHT === 'True') {
    ...
    try {
      ...
      const {
        ...
        getLastModelServiceRequestHeaders,
      ...
      // Test-only endpoint to read headers from the last model service request
      app.get('/api/test/model-service-request-headers', (_req, res) => {
        res.json(getLastModelServiceRequestHeaders());
      });
